 ...
 */
Ext.define('FlexCenter.activiti.view.CKEditor', {
    extend: 'Ext.form.field.TextArea',
    alias: 'widget.ckeditor',
    id: 'ckeditor',
    value:'<table xtype="table" border="1" cellpadding="1" cellspacing="1" style="width:800px"><tbody><tr><th colspan="4">标题</th></tr><tr><th style="width: 200px;">字段一</th><td>&nbsp;</td><th style="width: 200px;"><strong>字段二</strong></th><td>&nbsp;</td></tr><tr><th><strong>字段三</strong></th><td>&nbsp;</td><th><strong>字段四</strong></th><td>&nbsp;</td></tr></tbody></table>',
