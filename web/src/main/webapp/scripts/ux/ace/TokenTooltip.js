...
define('ace/token_tooltip', ['require', 'exports', 'module' , 'ace/lib/dom', 'ace/lib/event', 'ace/range'], function(require, exports, module) {
  ...
  var TokenTooltip = function(editor, aceEditor) {
  ...
  (function(){
    ...
    this.update = function() {
      ...
      var tokenText = null;
      if (this.aceEditor) {
        tokenText = this.aceEditor.getTokenTip(token);
      }
      if (!tokenText) {
        var tType = token.type;
        if (tType == 'string' || tType == 'constant.numeric' || tType == 'constant.language.boolean' || tType == 'punctuation.operator' || tType == 'keyword.operator') {
          tokenText = tType.substr(tType.lastIndexOf('.')+1);
        }
      }
