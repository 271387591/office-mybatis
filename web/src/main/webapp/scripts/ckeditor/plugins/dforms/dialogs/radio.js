 ...
 */
CKEDITOR.dialog.add('dradio', function(editor) {
			return {
										...
										commit : function(data) {
											...
											if (!(CKEDITOR.env.ie || CKEDITOR.env.opera)) {
												...
												if (isElementChecked != isChecked) {
													var replace = CKEDITOR.dom.element.createFromHtml('<input type="radio"' + (isChecked ? ' checked="checked"' : '') + '></input>', editor.document);
