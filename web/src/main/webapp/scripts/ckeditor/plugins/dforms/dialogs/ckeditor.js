...
{
	return {
		title : editor.lang.dforms.ckeditor.title,
		minWidth : 350,
		minHeight : 130,
		onShow : function()
		{
		...
		contents : [
			{
				id : 'info',
				label : editor.lang.dforms.ckeditor.title,
				title : editor.lang.dforms.ckeditor.title,
				elements : [
					{
						type : 'hbox',
...
//									editor.lang.forms.common.name+ editor.lang.dforms.dcommon.colNameValidate),
							'default' : '',
							accessKey : 'N',
