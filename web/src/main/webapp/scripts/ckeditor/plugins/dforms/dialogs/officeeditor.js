...
*/
CKEDITOR.dialog.add( 'officeeditor', function( editor )
{
	return {
		title : editor.lang.dforms.officeeditor.title,
		minWidth : 350,
		minHeight : 130,
		onShow : function()
		{
		...
		onOk : function()
		{
			...
			element.setAttribute('xtype'	, 'officeeditor' );
			element.setAttribute('txtvaluetype'	, 'bigint' );
		...
		contents : [
			{
				id : 'info',
				label : editor.lang.dforms.officeeditor.title,
				title : editor.lang.dforms.officeeditor.title,
				elements : [
					{
						type : 'hbox',
