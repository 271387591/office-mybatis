 ...
 */
CKEDITOR.dialog.add('dcheckbox', function(editor) {
			return {
							...
							elements : [{
										...
										children : [{
													...
													validate : CKEDITOR.dialog.validate.colNameValidate(
															editor.lang.common.name+ editor.lang.dforms.dcommon.colNameValidate),
										...
										commit : function(data) {
											...
											if (value && !(CKEDITOR.env.ie && value == 'on'))
												...
												if (CKEDITOR.env.ie) {
													...
													element.copyAttributes(checkbox, {
																value : 1
															});
										...
										commit : function(data) {
											...
											if (CKEDITOR.env.ie) {
												...
												if (isElementChecked != isChecked) {
													var replace = CKEDITOR.dom.element.createFromHtml('<input type="checkbox"' + (isChecked ? ' checked="checked"' : '') + '/>', editor.document);
