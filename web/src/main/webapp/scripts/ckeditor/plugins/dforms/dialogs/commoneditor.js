...
*/
CKEDITOR.dialog.add( 'commoneditor', function( editor )
{
	return {
		title : editor.lang.dforms.commoneditor.title,
		minWidth : 350,
		minHeight : 130,
		onShow : function()
		{
		...
		onOk : function()
		{
			...
			element.setAttribute('xtype'	, 'commoneditor' );
			element.setAttribute('txtvaluetype'	, 'text' );
			element.setAttribute('txtsize'	,4000 );
		...
		contents : [
			{
				id : 'info',
				label : editor.lang.dforms.commoneditor.title,
				title : editor.lang.dforms.commoneditor.title,
				elements : [
					{
						type : 'hbox',
